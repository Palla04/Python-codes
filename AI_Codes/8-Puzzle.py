...
def is_solvable(state):
    # Count inversions in the list ignoring the blank tile (0)
    inv_count = 0
...
def main():
    print("Enter the start state in a single line (e.g., 1 2 3 4 5 6 7 8 0):")
    start_state = list(map(int, input().split()))
    print("Enter the goal state in a single line (e.g., 1 2 3 4 5 6 7 8 0):")
    ...
    print("h1: Constant zero heuristic (Dijkstra's algorithm)")
    print("h2: Number of misplaced tiles heuristic")
    print("h3: Sum of Manhattan distances heuristic")
    ...
    # Perform A* search with the chosen heuristic
